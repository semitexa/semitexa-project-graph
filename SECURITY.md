...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-project-graph/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/project-graph`) in the subject.
...
In scope: anything in `semitexa/project-graph` that lets a request, a job or a message do
